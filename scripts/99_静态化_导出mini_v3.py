"""
静态化导出 v3 — 把小光剑 /mini-v3/ 子系统冻结为 HTML 静态站点

用法:
    cd lightsaber && python scripts/99_静态化_导出mini_v3.py
...
链接重写规则:
- index.html 里: /mini/v3/stock/HK:00700  → stock/HK_00700.html
- stock/X.html 里: /mini/v3/              → ../index.html
"""
import os
import re
import sys
